...
def personal_assistant():
    def greet():
        name = input("Can you help me with your name please? : ")
        print(f"Hello {name}, Your personal assistant is here.")
    greet()
    ...
    while is_running:
        ...
        main_menu = {
            '1': calculator, '2': text_analyzer, '3': Grades, '4': game, '5': to_do_list }
        
        task = input("Enter task you want to perform: ").lower()
